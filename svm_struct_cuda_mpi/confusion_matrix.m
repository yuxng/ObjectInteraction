function [cmatrix, ctable, accuracy, mae] = confusion_matrix(cls, vnum)
...
switch cls
    ...
    case 'car_3D'
        ...
        cad_num = 1;       
    case 'car_3D_occld'
        cls_data = 'car_3D_occld';
        cls_cad = 'car';
        index_test = 2713:3228;
        cad_num = 1;
end
...
% prediction
fpr = fopen(sprintf('data/%s.pre', cls), 'r');
    ...
    for j = 1:n
        ...
        for k = 1:num
            ...
            if o >= 0.5
                ...
                cad_label = A{k}.cad_label + 1;
                azimuth_pr = cad{cad_label}.parts2d(view_label).azimuth;
